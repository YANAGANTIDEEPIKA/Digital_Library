...
<div class="container">
    <div class="innerdiv">
           ...
           <!-- <Button class="pinkbtn" >Admin</Button> -->
                <Button class="pinkbtn" onclick="openpart('addbook')" > ADD BOOK</Button>
                <Button class="pinkbtn" onclick="openpart('bookreport')" > BOOK REPORT</Button>
                <Button class="pinkbtn" onclick="openpart('bookrequestapprove')"> BOOK REQUESTS</Button>
                <Button class="pinkbtn" onclick="openpart('addperson')"> ADD STUDENT</Button>
                <Button class="pinkbtn" onclick="openpart('studentrecord')"> STUDENT REPORT</Button>
                <Button class="pinkbtn"  onclick="openpart('issuebook')">  ISSUE BOOK</Button>
                <Button class="pinkbtn" onclick="openpart('issuebookreport')"> ISSUE REPORT</Button>
                <a href="index.php"><Button class="pinkbtn" >LOGOUT</Button></a>
           </div>
                         <!-- book request by student by student or teachers -->

           <div class="rightinnerdiv">   
            <div id="bookrequestapprove" class="innerright portion" style="display:none">
            <Button class="pinkbtn" >BOOK REQUEST APPROVE</Button>
            ...
            <Button class="pinkbtn" >ADD Person</Button>
            ...
            <Button class="pinkbtn" >BOOK RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
...
<div class="rightinnerdiv">   
            ...
            <Button class="pinkbtn" >BOOK DETAIL</Button>
</br>
<?php
            $u=new data;
            $u->setconnection();
...
?>
            ...
            <Button class="pinkbtn" >ISSUE BOOK</Button>
...
<br>
           <label>Days</label> <input type="number" name="days"/>
            ...
            <Button class="pinkbtn" >Student RECORD</Button>
            ...
            <Button class="pinkbtn" >ADD NEW BOOK</Button>
            <br>
...
<!-- .imglogo {
        ...
        .innerdiv {
            text-align: center;
            margin: 50px 0; /* Adjusted margin for better responsiveness */
        }
