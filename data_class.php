...
class data extends db {
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $bookpub, $branch, $bookprice, $bookquantity) {
        ...
        $q = "INSERT INTO book (bookpic, bookname, bookdetail, bookaudor, bookpub, branch, bookprice, bookquantity, bookava, bookrent) 
              VALUES (:bookpic, :bookname, :bookdetail, :bookaudor, :bookpub, :branch, :bookprice, :bookquantity, :bookquantity, 0)";
    
        // Prepare the SQL statement
        $stmt = $this->connection->prepare($q);
    
        // Execute the statement with safe parameter binding
    ...
    function deletebook($id){
        try {
            ...
            $id = intval($id); // Ensures it's an integer (prevents SQL injection)
            ...
            error_log("Error deleting book: " . $e->getMessage()); // Log error
            return false;
        }
    }
